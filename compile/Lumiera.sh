...
apt-get install build-essential autoconf scons valgrind libtool git-core libboost-dev libboost-program-options-dev libboost-regex-dev libboost-filesystem-dev libgavl-dev libgdl-1-dev libgtkmm-2.4-dev librsvg2-dev libxv-dev

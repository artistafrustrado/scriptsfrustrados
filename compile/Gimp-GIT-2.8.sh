...
export PKG_CONFIG_PATH=/opt/git/gimp/lib/pkgconfig:/opt/git/gimp/share/pkgconfig:$PKG_CONFIG_PATH
export GEGL_LIBS=/opt/git/gimp/lib
export BABL_LIBS=/opt/git/gimp/lib
export BABL_CFLAGS=/opt/git/gimp/bin 

export GEGL_CFLAGS=/opt/git/gimp/bin 
export GEGL_LIBS=/opt/git/gimp/lib 
export LD_RUN_PATH=/opt/git/gimp/lib 
